...
Now we know that the two groups are normal, so now we need to test their covariance matrices using the Box-m test for homogeneity <br>
- h0: hypothesis: The covariance matrices are equal <br>
- h1: The covariance matrices differ.  

We calculate the C value and test if it is above a critical chi-square value using the function below  <br> 
